...
export default function ClientShell({ unreadCount = 0, userName, children }: Props) {
  ...
  return (
    <div className="min-h-dvh bg-bg">
      ...
      <main className={`w-full mx-auto px-6 md:px-10 pt-[calc(0.75rem+env(safe-area-inset-top))] md:pt-12 pb-[calc(6rem+env(safe-area-inset-bottom))] md:pb-20 ${contentMax}`}>
        {children}
      </main>
